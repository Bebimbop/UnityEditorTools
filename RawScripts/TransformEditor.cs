...
public class TransformEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            serializedObject.FindProperty("m_LocalPosition").vector3Value = savedPositionValue;
        }
        if (GUILayout.Button("Reset Rotation"))
        {
            serializedObject.FindProperty("m_LocalRotation").quaternionValue = savedRotationValue;
        }
        if (GUILayout.Button("Reset Scale"))
        {
            serializedObject.FindProperty("m_LocalScale").vector3Value = savedScaleValue;
        }
